...
class Config:
    ...
    def anime_naming_rule(self) -> str:
        return self.conf.get("Name_Rule", "anime_naming_rule")
    def location_rule(self) -> str:
        return self.conf.get("Name_Rule", "location_rule")
    def anime_location_rule(self) -> str:
        return self.conf.get("Name_Rule","anime_location_rule")
    ...
    def _default_config() -> configparser.ConfigParser:
        ...
        conf.set(sec4, "location_rule", "'#'+actor+'/'+'['+year+'] '+title+' ['+number+']'")
        conf.set(sec4, "anime_location_rule","'#'+actor+'/'+'['+year+'] '+title")
        conf.set(sec4, "naming_rule", "number + '-' + title")
        conf.set(sec4, "anime_naming_rule", "title")
